package tsciam::Explore::orgarea;
#  W5Base Framework
...
sub getObjectInfo
{
   ...
   return({
      label=>"CIAM Organisationstructure",
      description=>"Visualisation for organisational structures based on Telekom CIAM Data",
      sublabel=>"IT-Uinversum-&gt;CIAM",
      prio=>'1000'
   });
}
