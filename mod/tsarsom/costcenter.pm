...
sub new
{
   ...
   $self->AddFields(
      ...
      new kernel::Field::Id(
                name          =>'id',
                label         =>'CostCenterID',
                dataobjattr   =>'v_om_ac_costcenter.datensatz_nr'),

      new kernel::Field::Text(
                name          =>'name',
                label         =>'CostCenter-No.',
                dataobjattr   =>'v_om_ac_costcenter.kostenstelle'),
      ...
      new kernel::Field::Date(
                ...
                dataobjattr   =>"TO_DATE('19700101000000','YYYYMMDDHH24MISS')+".
                  "NUMTODSINTERVAL(v_om_ac_costcenter.modified_date,'SECOND')")
   );
...
sub Initialize
{
   ...
   $self->setWorktable("v_om_ac_costcenter");
