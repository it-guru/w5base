...
sub new
{
   ...
   $self->AddFields(
      ...
      new kernel::Field::Id(
                name          =>'id',
                label         =>'AssetID',
                dataobjattr   =>"v_om_ac_asset.service_id"),

      new kernel::Field::Text(
                name          =>'name',
                label         =>'Name',
                dataobjattr   =>'v_om_ac_asset.apv_key'),
      ...
      new kernel::Field::Date(
                ...
                dataobjattr   =>"TO_DATE('19700101000000','YYYYMMDDHH24MISS')+".
                  "NUMTODSINTERVAL(v_om_ac_asset.letzte_änderung_am,'SECOND')")
   );
...
sub Initialize
{
   ...
   $self->setWorktable("v_om_ac_asset");
