...
sub new
{
   ...
   $self->AddFields(
      ...
      new kernel::Field::Id(
                name          =>'id',
                label         =>'LocationID',
                dataobjattr   =>'v_om_ac_location.datensatz_nr_'),

      new kernel::Field::Text(
                name          =>'name',
                label         =>'Standort',
                dataobjattr   =>'v_om_ac_location.name'),
      ...
      new kernel::Field::Date(
                ...
                dataobjattr   =>"TO_DATE('19700101000000','YYYYMMDDHH24MISS')+".
                  "NUMTODSINTERVAL(v_om_ac_location.geaendert_am,'SECOND')")
   );
...
sub Initialize
{
   ...
   $self->setWorktable("v_om_ac_location");
