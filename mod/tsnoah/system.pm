...
sub getSqlFrom
{
   ...
   my $from=
      "(select device_id id, 
               ...
               devicetyp systemtyp,
               service_id systemid,
               wm_concat(distinct fachkonzept) techconcept,
               max(tsiimp.darwin_device.timestamp) mdate 
       from tsiimp.darwin_device 
       group by device_id,devicename,devicetyp,service_id) lsys";
