...
sub new
{
   ...
   $self->AddFields(
      ...
      new kernel::Field::Text(    name    =>'accountno',
                                  label    =>'Accountnummer',
                                  dataobjattr  =>'ip.acnummer'),
      new kernel::Field::Text(    name    =>'ifname',
                                  label    =>'ifname',
                                  dataobjattr  =>'ip.ifname'),
      new kernel::Field::Text(    name    =>'kabelbez',
                                  label    =>'kabelbez',
                                  dataobjattr  =>'ip.kabelbez'),
