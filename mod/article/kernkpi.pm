...
sub new
{
   ...
   $self->AddFields(
      ...
      new kernel::Field::Id(
                ...
                label         =>'W5BaseID',
                dataobjattr   =>'artkernkpi.id'),
                                                  
      new kernel::Field::Text(
                name          =>'name',
                label         =>'internal name',
                dataobjattr   =>'artkernkpi.name'),
     ...
     #           dataobjattr   =>"concat(artkernkpi.selectlabel,".
     #                           "'-',artkernkpi.name)"),
      ...
      new kernel::Field::Link(
                name          =>'cistatusid',
                label         =>'CI-StateID',
                dataobjattr   =>'artkernkpi.cistatus'),
      ...
      new kernel::Field::Textarea(
                ...
                selectfix     =>1,
                label         =>'label data',
                dataobjattr   =>'artkernkpi.labeldata'),
      ...
      new kernel::Field::Textarea(
                ...
                label         =>'Comments',
                searchable    =>0,
                dataobjattr   =>'artkernkpi.comments'),
      ...
      new kernel::Field::CDate(
                ...
                sqlorder      =>'desc',
                label         =>'Creation-Date',
                dataobjattr   =>'artkernkpi.createdate'),
      ...
      new kernel::Field::MDate(
                ...
                dataobjattr   =>'artkernkpi.modifydate'),

      new kernel::Field::Creator(
                name          =>'creator',
                group         =>'source',
                label         =>'Creator',
                dataobjattr   =>'artkernkpi.createuser'),

      new kernel::Field::Owner(
                name          =>'owner',
                group         =>'source',
                label         =>'Owner',
                dataobjattr   =>'artkernkpi.modifyuser'),

      new kernel::Field::Editor(
                name          =>'editor',
                group         =>'source',
                label         =>'Editor',
                dataobjattr   =>'artkernkpi.editor'),

      new kernel::Field::RealEditor(
                name          =>'realeditor',
                group         =>'source',
                label         =>'RealEditor',
                dataobjattr   =>'artkernkpi.realeditor'),

   );
   $self->setDefaultView(qw(linenumber displaylabel cistatus mdate));
   $self->setWorktable("artkernkpi");
   return($self);
}
