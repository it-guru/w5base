...
{
   my $self=shift;
   $self->{DataObj}=getModuleObject($self->getParent->Config,"base::lnkgrpuser");
...
sub Result
{
   ...
   my %grp=$self->getParent->getGroupsOf($ENV{REMOTE_USER},"REmployee");
