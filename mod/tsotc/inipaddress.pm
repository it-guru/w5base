...
sub new
{
   ...
   $self->AddFields(
      new kernel::Field::Id(
                name          =>'id',
                label         =>'INet-IP-AddressID',
                group         =>'source',
                dataobjattr   =>"floating_ip_uuid"),

      new kernel::Field::Text(
                name          =>'name',
                label         =>'INet-IP-Address',
                dataobjattr   =>"floating_ip_address"),
      ...
      new kernel::Field::Text(
                ...
                label         =>'OTC-SystemID',
                dataobjattr   =>
                 "otc4darwin_floating_ips_used_last_four_hours_vw.server_uuid"),
      ...
      new kernel::Field::CDate(
                ...
                label         =>'Creation-Date',
                timezone      =>'CET',
                dataobjattr   =>"creation_date"),

   );
   $self->setDefaultView(qw(systemname name hwaddr systemid projectname));
   $self->setWorktable("otc4darwin_floating_ips_used_last_four_hours_vw");
   return($self);
}
