...
sub new
{
   ...
   $self->AddFields(
      ...
      new kernel::Field::SubList(
                ...
                label         =>'Namespaces',
                group         =>'namespaces',
                vjointo       =>\'tsotc::appagilenamespace',
                vjoinon       =>['id'=>'clusterid'],
                vjoindisp     =>['name','appl','lastmondate']),
...
sub getDetailBlockPriority
{
   ...
   my $grp=shift;
   my %param=@_;
   return("header","default","namespaces","source");
}
