...
sub new
{
   ...
   $self->AddFields(
      ...
      new kernel::Field::Link(
                name          =>'producerid',
                dataobjattr   =>'hwmodel.producer'),

      new kernel::Field::Textarea(
                name          =>'comments',
                label         =>'Comments',
                dataobjattr   =>'hwmodel.comments'),
      ...
      new kernel::Field::Text(
                ...
                group         =>'source',
                label         =>'Source-System',
                dataobjattr   =>'hwmodel.srcsys'),
                                                   
      new kernel::Field::Text(
                name          =>'srcid',
                group         =>'source',
                label         =>'Source-Id',
                dataobjattr   =>'hwmodel.srcid'),
                                                   
      new kernel::Field::Date(
                name          =>'srcload',
                group         =>'source',
                label         =>'Source-Load',
                dataobjattr   =>'hwmodel.srcload'),
      ...
      new kernel::Field::CDate(
                ...
                sqlorder      =>'desc',
                label         =>'Creation-Date',
                dataobjattr   =>'hwmodel.createdate'),
      ...
      new kernel::Field::Creator(
                ...
                group         =>'source',
                label         =>'Creator',
                dataobjattr   =>'hwmodel.createuser'),

      new kernel::Field::Owner(
                name          =>'owner',
                group         =>'source',
                label         =>'last Editor',
                dataobjattr   =>'hwmodel.modifyuser'),

      new kernel::Field::Editor(
                name          =>'editor',
                group         =>'source',
                label         =>'Editor Account',
                dataobjattr   =>'hwmodel.editor'),

      new kernel::Field::RealEditor( 
                name          =>'realeditor',
                group         =>'source',
                label         =>'real Editor Account',
                dataobjattr   =>'hwmodel.realeditor'),
