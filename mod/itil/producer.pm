...
sub new
{
   ...
   $self->AddFields(
      ...
      new kernel::Field::Link(
                name          =>'cistatusid',
                label         =>'CI-StateID',
                dataobjattr   =>'producer.cistatus'),

      new kernel::Field::Textarea(
                name          =>'comments',
                label         =>'Comments',
                dataobjattr   =>'producer.comments'),
      ...
      new kernel::Field::Container(
                ...
                dataobjattr   =>'producer.additional'),

      new kernel::Field::Text(
                name          =>'srcsys',
                group         =>'source',
                label         =>'Source-System',
                dataobjattr   =>'producer.srcsys'),
                                                   
      new kernel::Field::Text(
                name          =>'srcid',
                group         =>'source',
                label         =>'Source-Id',
                dataobjattr   =>'producer.srcid'),
                                                   
      new kernel::Field::Date(
                name          =>'srcload',
                group         =>'source',
                label         =>'Source-Load',
                dataobjattr   =>'producer.srcload'),
      ...
      new kernel::Field::CDate(
                ...
                sqlorder      =>'desc',
                label         =>'Creation-Date',
                dataobjattr   =>'producer.createdate'),
      ...
      new kernel::Field::Creator(
                ...
                group         =>'source',
                label         =>'Creator',
                dataobjattr   =>'producer.createuser'),

      new kernel::Field::Owner(
                name          =>'owner',
                group         =>'source',
                label         =>'last Editor',
                dataobjattr   =>'producer.modifyuser'),

      new kernel::Field::Editor(
                name          =>'editor',
                group         =>'source',
                label         =>'Editor Account',
                dataobjattr   =>'producer.editor'),

      new kernel::Field::RealEditor(
                name          =>'realeditor',
                group         =>'source',
                label         =>'real Editor Account',
                dataobjattr   =>'producer.realeditor'),
