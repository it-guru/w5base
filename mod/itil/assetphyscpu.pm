...
sub getSqlFrom
{
   ...
   $from.="asset left outer join w5seq on w5seq.id<asset.cpucount ".
          "left outer join assetphyscpu on asset.id=assetphyscpu.asset and ".
          "assetphyscpu.cpuid=w5seq.id";
