...
{
   my $self=shift;
   my $timelabel=$self->getParent->T("Last edit time");;
...
sub Result
{
   ...
   $q1{mdate}=Query->Param("Search_TimeRange");
   $q1{mdate}="<now AND >now-24h" if (!defined($q1{mdate}));
