...
{  
   ...
   return($self->InitFields(
      new kernel::Field::Date(    name       =>'eventstartofevent',
                                  translation=>'itil::workflow::eventnotify',
      ...
      new kernel::Field::KeyText( name       =>'affectedlocation',
                                  translation=>'itil::workflow::base',
      ...
      new kernel::Field::KeyText( name       =>'affectedlocationid',
                                  htmldetail =>0,
                                  translation=>'itil::workflow::base',
                                  searchable =>0,
                                  keyhandler =>'kh',
      ...
      new kernel::Field::Select(  name       =>'affectedroom',
                                  translation=>'itil::workflow::base',
                                  container  =>'headref',
                                  group      =>'eventnotifyshort',
                                  ...
                                  depend     =>['eventmode'],
                                  label      =>'Affected Room'),
      new kernel::Field::Select(  name       =>'affectednetwork',
                                  ...
                                  depend     =>['eventmode'],
                                  label      =>'Networkarea'),
      new kernel::Field::Link(    name       =>'affectednetworkid',
                                  container  =>'headref',
                                  label      =>'NetworkareaID'),
      new kernel::Field::Select(  name       =>'affectedregion',
                                  translation=>'itil::workflow::eventnotify',
                                  container  =>'headref',
                                  value      =>[qw( 
                                                    EVregion.unknown
      ...
      new kernel::Field::Textarea(name       =>'eventreason',
                                  translation=>'itil::workflow::eventnotify',
                                  group      =>'eventnotify',
                                  label      =>'Event reason',
                                  container  =>'headref'),
      new kernel::Field::Textarea(name       =>'eventimpact',
                                  translation=>'itil::workflow::eventnotify',
                                  group      =>'eventnotify',
                                  label      =>'Impact for customer',
                                  container  =>'headref'),
      new kernel::Field::Textarea(name       =>'shorteventelimination',
                                  translation=>'itil::workflow::eventnotify',
                                  group      =>'eventnotify',
                                  label      =>'Action for short event '.
                                               'elimination',
                                  container  =>'headref'),
      new kernel::Field::Textarea(name       =>'longeventelimination',
                                  translation=>'itil::workflow::eventnotify',
                                  group      =>'eventnotify',
                                  label      =>'Action for long event '.
                                               'elimination',
                                  container  =>'headref'),

      new kernel::Field::Textarea(name       =>'eventaltdesciption',
                                  dlabelpref =>\&LangPrefix,
                                  translation=>'itil::workflow::eventnotify',
                                  group      =>'alteventnotify',
                                  label      =>'Whats happend',
                                  container  =>'headref'),
      new kernel::Field::Textarea(name       =>'eventaltreason',
                                  dlabelpref =>\&LangPrefix,
                                  translation=>'itil::workflow::eventnotify',
                                  group      =>'alteventnotify',
                                  label      =>'Event reason',
                                  container  =>'headref'),
      new kernel::Field::Textarea(name       =>'eventaltimpact',
                                  dlabelpref =>\&LangPrefix,
                                  translation=>'itil::workflow::eventnotify',
                                  group      =>'alteventnotify',
                                  label      =>'Impact for customer',
                                  container  =>'headref'),
      new kernel::Field::Textarea(name       =>'altshorteventelimination',
                                  dlabelpref =>\&LangPrefix,
                                  translation=>'itil::workflow::eventnotify',
                                  group      =>'alteventnotify',
                                  label      =>'Action for short event '.
                                               'elimination',
                                  container  =>'headref'),
      new kernel::Field::Textarea(name       =>'altlongeventelimination',
                                  dlabelpref =>\&LangPrefix,
                                  translation=>'itil::workflow::eventnotify',
                                  group      =>'alteventnotify',
                                  label      =>'Action for long event '.
      ...
      new kernel::Field::Select(  name       =>'eventlang',
                                  translation=>'itil::workflow::eventnotify',
                                  ...
                                  container  =>'headref'),
      new kernel::Field::Select(  name       =>'eventsla',
                                  translation=>'itil::workflow::eventnotify',
                                  group      =>'eventnotifyinternal',
                                  transprefix=>'boolean.',
                                  htmleditwidth=>'150px',
                                  ...
                                  container  =>'headref'),
      new kernel::Field::Text(    name       =>'eventprmticket',
                                  translation=>'itil::workflow::eventnotify',
                                  group      =>'eventnotifyinternal',
                                  label      =>'related problem ticket',
                                  container  =>'headref'),
      new kernel::Field::Text(    name       =>'eventinmticket',
                                  translation=>'itil::workflow::eventnotify',
                                  group      =>'eventnotifyinternal',
                                  label      =>'related incident ticket',
                                  container  =>'headref'),
      new kernel::Field::Textarea(name       =>'eventinternalslacomments',
                                  translation=>'itil::workflow::eventnotify',
                                  group      =>'eventnotifyinternal',
                                  label      =>'Arguments, if not SLA relevant',
                                  container  =>'headref'),
      new kernel::Field::Textarea(name       =>'eventinternalcomments',
                                  translation=>'itil::workflow::eventnotify',
                                  group      =>'eventnotifyinternal',
                                  label      =>'Internal comments',
                                  container  =>'headref'),

      new kernel::Field::Select(  name       =>'eventstatnature',
                                  translation=>'itil::workflow::eventnotify',
                                  ...
                                  label      =>'Event nature',
                                  container  =>'headref'),
      new kernel::Field::Select(  name       =>'eventstattype',
                                  translation=>'itil::workflow::eventnotify',
                                  group      =>'eventnotifystat',
                                  getPostibleValues=>\&FgetPosibleEventStatType,
                                  label      =>'Event type',
                                  container  =>'headref'),
      new kernel::Field::Select(  name       =>'eventstatreason',
                                  translation=>'itil::workflow::eventnotify',
                                  group      =>'eventnotifystat',
                                  value      =>['',
                                                'EVr.application',
                                  ...
                                  label      =>'Event reason',
                                  container  =>'headref'),
      new kernel::Field::Select(  name       =>'eventstatclass',
                                  translation=>'itil::workflow::eventnotify',
                                  group      =>'eventnotifystat',
                                  label      =>'Event class',
                                  delfault   =>'1',
                                  ...
                                  value      =>['1',
                                                ...
                                                '5'],
                                  container  =>'headref'),
      new kernel::Field::Select(  name       =>'eventmode',
                                  translation=>'itil::workflow::eventnotify',
                                  group      =>'state',
                                  value      =>['EVk.appl',
                                                'EVk.net',
