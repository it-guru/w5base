   ...
   if ($param ne "" && $param>0){
      ...
      if (defined($wfrec)){
         ...
         my %I=('brief.description'     => $name,
                'problem.shortname'     => 'TSI-D-BAMBERG',
                'assignment'            => 'CSS.TCOM.GHS-TSI.GD.SC',
                'category'              => 'ACCESS',
                'subcategory1'          => 'OTHER',
                'cause.code'            => 'SC.PWD.ENG',
                'priority.code'         => '3',
                'business.impact'       => 'Low',
                'urgency'               => 'Medium',
                'sla.relevant'          => '0',
                ...
                'reported.mail.address' => 'hartmut.vogler@t-systems.com',
                'reported.phone'        => '+49 951 1336-4333',
