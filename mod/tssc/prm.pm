...
sub new
{
   ...
   $self->AddFields(
      ...
      new kernel::Field::Text(
                ...
                dataobjattr   =>'rootcausem1.business_impact'),
      ...
      new kernel::Field::Text(
                ...
                group         =>'status',
                label         =>'Triggered by',
                dataobjattr   =>'rootcausem1.triggered_by'),
      ...
      new kernel::Field::Text(
                ...
                htmldetail    =>\&onlyIfFilled,
                label         =>'Systemname',
                dataobjattr   =>'rootcausem1.system_name'),
      ...
      new kernel::Field::Textarea(
                ...
                group         =>'close',
                searchable    =>0,
                dataobjattr   =>'rootcausea4.workaround'),
