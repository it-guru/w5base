...
sub new
{
   ...
   $self->AddFields(
      ...
      new kernel::Field::Select(
                ...
                wrdataobjattr =>'networkarea',
                dataobjattr   =>"decode(networkarea,NULL,'LAN',networkarea)"),
      ...
      new kernel::Field::Select(
                ...
                value         =>["NET","Application","Central Services",
                                 "FW","LB","SAN"],
                wrdataobjattr =>'networkclass',
                dataobjattr   =>"decode(networkclass,NULL,'NET',networkclass)"),
