...
sub COMigrationToolTRAFO
{
   ...
   $ENV{REMOTE_USER}="service/TSI_TRAFO_Mig";
   ...
   if ($total>0){
      ...
      if (keys(%to)!=0){
         $wfa->Notify("INFO",
           ...
           "Because of the necessary migration in T-Systems ".
           "(TRAFO-Migration) corrections in W5Base/Darwin were ".
