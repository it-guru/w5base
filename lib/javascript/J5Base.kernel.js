...
var W5baseObject = function(config,module){
   ...
   this.getHashList=this.findRecord=function(view,processCallback){
         ...
         if (requesturl.length>2000){
            ...
            $.ajax({
                ...
                error:function (XMLHttpRequest, textStatus, errorThrown){
                   if (window.console){
                      console.log("call error:"+textStatus+" call: "+this.url);
                   }
                   alert("call error:"+textStatus+" call: "+this.url);
                },
                success: function (data) {
                  // console.log("JSON ready:",data);
                   this.w5base.processCallback(data);
                },
                url:requesturl
            });
         }
