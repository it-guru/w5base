      ...
      for(var i=0;i<val.length;i++){
         ...
         for(var f=0;f<this.options.filter.length;f++){
            ...
            if (f==this.options.currentFilter){
               ...
               if (secCurVal.substring(0,secCurKey.length)!=secCurKey){
                  useData=false;
                  break;
               }
            }
            ...
            if (this.visualObj[usedKey]==undefined){
               ...
               if (this.options.aggregation=='avg'){
                  ...
                  this.visualObj[usedKey].value=
                        parseFloat((this.visualObj[usedKey].value+usev)/usediv);
               }
               else if (this.options.aggregation=='sum'){
                  this.visualObj[usedKey].value+=v;
               }
               else{
                  this.visualObj[usedKey].value=0;
               }
