...
{
   pHtmlElement.parentElement.parentElement.parentElement.parentElement.parentElement.style.backgroundColor="silver";
   pHtmlElement.style.pointerEvents="none";
   pHtmlElement.style.cursor ="progress";
   parent.DoRemoteSearch("Result","DirectView",format,undefined,0);
   setViewFrame(1);
}
...
function DirectDownload(pHtmlElement,format,target)
{
   ...
   format=">"+format;
   parent.DoRemoteSearch("Result","DirectView",format,undefined,0);
   pHtmlElement.parentElement.parentElement.parentElement.parentElement.parentElement.parentElement.parentElement.parentElement.parentElement.style.backgroundColor="silver";
}
