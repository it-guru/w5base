...
Autoreq: 0
Source0: apache-mod_ae-0.21.tgz
...
zcat $RPM_SOURCE_DIR/apache-mod_ae-0.21.tgz | tar -xvf -
...
%build
cd $RPM_BUILD_DIR/apache-mod_ae-0.21/src
make clean
make
cd $RPM_BUILD_DIR/apache-mod_ae-0.21/apache2
...
./configure --prefix=/opt/samba \
            ...
            -without-krb5
make
cp -a $RPM_BUILD_DIR/apache-mod_ae-0.21/contrib/authscripts/samba-3.0.37/examples/smb3passchk $RPM_BUILD_DIR/samba-3.0.37/examples
cd $RPM_BUILD_DIR/samba-3.0.37/examples/smb3passchk
make

%install
rm -rf $RPM_BUILD_ROOT/*
cd $RPM_BUILD_DIR/apache-mod_ae-0.21/bin
...
cd $RPM_BUILD_DIR/apache-mod_ae-0.21
