...
#endif
    if (items != 2)
       Perl_croak(aTHX_ "Usage: %s(%s)", "IPC::Smart::constant", "name, arg");
...
#endif
    if (items != 4)
       Perl_croak(aTHX_ "Usage: %s(%s)", "IPC::Smart::new_share", "key, segment_size, flags, nolocking");
    PERL_UNUSED_VAR(cv); /* -W */
    {
...
#endif
    if (items != 1)
       Perl_croak(aTHX_ "Usage: %s(%s)", "IPC::Smart::smart_watched", "share");
    PERL_UNUSED_VAR(cv); /* -W */
    {
...
#endif
    if (items != 3)
       Perl_croak(aTHX_ "Usage: %s(%s)", "IPC::Smart::write_share", "share, data, length");
    PERL_UNUSED_VAR(cv); /* -W */
    {
	Share*		share = (Share *)SvIV(ST(0));
...
#endif
    if (items != 1)
       Perl_croak(aTHX_ "Usage: %s(%s)", "IPC::Smart::read_share", "share");
    PERL_UNUSED_VAR(cv); /* -W */
    {
	Share*		share = (Share *)SvIV(ST(0));
#line 340 "Smart.xs"
...
#endif
    if (items != 2)
       Perl_croak(aTHX_ "Usage: %s(%s)", "IPC::Smart::destroy_share", "share, rmid");
    PERL_UNUSED_VAR(cv); /* -W */
    {
	Share*		share = (Share *)SvIV(ST(0));
...
#endif
    if (items != 2)
       Perl_croak(aTHX_ "Usage: %s(%s)", "IPC::Smart::smart_lock", "share, flags");
    PERL_UNUSED_VAR(cv); /* -W */
    {
	Share*		share = (Share *)SvIV(ST(0));
...
#endif
    if (items != 1)
       Perl_croak(aTHX_ "Usage: %s(%s)", "IPC::Smart::smart_unlock", "share");
    PERL_UNUSED_VAR(cv); /* -W */
    {
	Share*		share = (Share *)SvIV(ST(0));
	int	RETVAL;
...
#endif
    if (items != 1)
       Perl_croak(aTHX_ "Usage: %s(%s)", "IPC::Smart::smart_version", "share");
    PERL_UNUSED_VAR(cv); /* -W */
    {
	Share*		share = (Share *)SvIV(ST(0));
	unsigned int	RETVAL;
...
#endif
    if (items != 1)
       Perl_croak(aTHX_ "Usage: %s(%s)", "IPC::Smart::smart_num_segments", "share");
    PERL_UNUSED_VAR(cv); /* -W */
    {
	Share*		share = (Share *)SvIV(ST(0));
	int	RETVAL;
