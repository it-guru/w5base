...
create table lnkapplapplcomp (
  ...
  obj1type     varchar(20) default NULL,
  obj1id       bigint(20)  NOT NULL,
  obj2type     varchar(20) default NULL,
  obj2id       bigint(20)  NOT NULL,
  obj3type     varchar(20) default NULL,
  obj3id       bigint(20)  NOT NULL,
  obj4type     varchar(20) default NULL,
  obj4id       bigint(20)  NOT NULL,
  comments     longtext    default NULL,
  createdate   datetime NOT NULL default '0000-00-00 00:00:00',
  modifydate   datetime NOT NULL default '0000-00-00 00:00:00',
  createuser   bigint(20) default NULL,
  ...
  srcload      datetime    default NULL,
  PRIMARY KEY  (id),
  KEY obj1 (obj1type,obj1id),
  KEY obj2 (obj2type,obj2id),
  KEY obj3 (obj3type,obj3id),
  KEY obj4 (obj4type,obj4id),
